...
public class StartNotificationService extends IntentService
{
    ...
    int mId = 1;
    String CHANNEL_ID = "Water_Intake";
    ...
    public void sendNotification()
    {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this,"Water_Intake")
                        .setSmallIcon(R.drawable.water_glass)
                        .setContentTitle("Drink water")
                        .setContentText("It's time to have a glass of water!").setChannelId(CHANNEL_ID);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(CHANNEL_ID,"HealthCare",NotificationManager.IMPORTANCE_HIGH);
